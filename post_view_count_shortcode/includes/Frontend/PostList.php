...
namespace WeDevs\PostViewCount\Frontend;
...
class PostList
{
    ...
    public function __construct() {
        ...
        add_shortcode( 'wedevs-pvcsc-post-list', [ $this, 'render_shortcode' ] );
    }
    ...
    public function get_posts_data () {
        ...
        $post_ids = isset( $this->atts['post_ids']) ? sanitize_text_field( $this->atts['post_ids'] ) : $defaults['post_in'];
